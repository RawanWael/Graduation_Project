...
class viewPatients extends StatefulWidget {
  ...
  @override
  State<viewPatients> createState() => _cardListViewState();
}

class _cardListViewState extends State<viewPatients> {
                ...
                child: NewGradientAppBar(
                  leading: Padding(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder:( context)=> MainLoginScreen()),
                        );
                                      ...
                                      child: Center(
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            //   MaterialPageRoute(builder: (context) =>  performsCardList() ),
                                            // );
                                          },
                                        ),
                                      )),
